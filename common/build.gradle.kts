...
dependencies {
    ...
    modCompileOnly("maven.modrinth:xaeros-world-map:${worldmap_version}_Fabric_1.19.1")
    modCompileOnly("maven.modrinth:xaeros-minimap:${minimap_version}_Fabric_1.19.1")
