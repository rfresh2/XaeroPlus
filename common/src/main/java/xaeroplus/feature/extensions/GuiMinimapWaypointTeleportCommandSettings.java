...
public class GuiMinimapWaypointTeleportCommandSettings extends Screen {
    ...
    protected void init() {
        ...
        this.saveButton = this.addRenderableWidget(
            new Button(
                this.width / 2 - 104, this.height / 2 + 26, 100, 20,
        ...
        this.addRenderableWidget(
            new Button(
                this.width / 2 + 4, this.height / 2 + 26, 100, 20,
    ...
    @Override
    public void render(final PoseStack poseStack, final int mouseX, final int mouseY, final float partialTick) {
