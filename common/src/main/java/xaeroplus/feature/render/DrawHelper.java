...
public class DrawHelper {
    ...
    public static void addColoredLineQuadToExistingBuffer(
        ...
        float x2t = pose.m00() * x2 + pose.m10() * y2 + pose.m30();
        float y2t = pose.m01() * x2 + pose.m11() * y2 + pose.m31();
        ...
        vertexBuffer.addVertex(pose, x1, y1, 0.0F).setColor(r, g, b, a).setUv(x2t, y2t);
        vertexBuffer.addVertex(pose, x1, y1, 0.0F).setColor(r, g, b, a).setUv(x2t, y2t);
        vertexBuffer.addVertex(pose, x1, y1, 0.0F).setColor(r, g, b, a).setUv(x2t, y2t);
        vertexBuffer.addVertex(pose, x1, y1, 0.0F).setColor(r, g, b, a).setUv(x2t, y2t);
    }
