...
public abstract class AbstractEllipseDrawFeature<T> implements DrawFeature {
    ...
    public void preRender(final DrawContext ctx) {
        if (ctx.worldmap()) {
            ...
            XaeroPlusShaders.setEllipsesFrameSize(window.getWidth(), window.getHeight());
        }
        ...
        XaeroPlusShaders.setEllipsesThickness(thicknessScale);
        XaeroPlusShaders.setEllipsesMapViewMatrix(ctx.untranslatedMapViewMatrix());
