...
public abstract class MixinGuiMap extends ScreenBase implements IRightClickableElement {
    ...
    public void customInitGui(CallbackInfo ci) {
        startDrawingButton = new GuiTexturedButton(
            0, this.attachedCameraButton.y - 20, 20, 20, 47, 0, 16, 16,
            Globals.guiTextures,
        ...
        drawEllipseButton = new GuiTexturedButton(
            startDrawingButton.x + 16, drawHighlightsButton.y + 20, 20, 20, 137, 19, 17, 17,
            Globals.guiTextures,
        ...
        drawTextButton = new GuiTexturedButton(
            startDrawingButton.x + 16, drawEllipseButton.y + 20, 20, 20, 119, 0, 16, 16,
            Globals.guiTextures,
        ...
        var colorPickerX = drawColorPickerButton.x + drawColorPickerButton.getWidth() + 4;
        var colorPickerY = startDrawingButton.y - 46;
        ...
        drawMeasurementToolButton = new GuiTexturedButton(
            startDrawingButton.x + 16, drawColorPickerButton.y + 20, 20, 20, 135, 0, 16, 16,
            Globals.guiTextures,
    ...
    @Inject(method = "keyPressed", at = @At("HEAD"), cancellable = true, remap = true)
    public void passKeyPressToFocusedColorPickerWidget(int code, int scanCode, int modifiers, CallbackInfoReturnable<Boolean> cir) {
        // i love 1.19.2!!!!
        if (getFocused() instanceof ColorPickerWidget colorPickerWidget) {
            colorPickerWidget.keyPressed(code, scanCode, modifiers);
            cir.setReturnValue(true);
        }
    }
