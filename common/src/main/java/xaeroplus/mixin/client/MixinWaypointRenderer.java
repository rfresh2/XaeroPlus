...
public class MixinWaypointRenderer {
    ...
    @WrapOperation(method = "renderElement(Lxaero/map/mods/gui/Waypoint;ZDFDDLxaero/map/element/render/ElementRenderInfo;Lxaero/map/element/MapElementGraphics;Lxaero/lib/client/graphics/XaeroBufferProvider;Lxaero/map/graphics/renderer/multitexture/MultiTextureRenderTypeRendererProvider;)Z", at = @At(
        value = "INVOKE",
    ...
    @WrapOperation(method = "renderElement(Lxaero/map/mods/gui/Waypoint;ZDFDDLxaero/map/element/render/ElementRenderInfo;Lxaero/map/element/MapElementGraphics;Lxaero/lib/client/graphics/XaeroBufferProvider;Lxaero/map/graphics/renderer/multitexture/MultiTextureRenderTypeRendererProvider;)Z", at = @At(
        value = "INVOKE",
        target = "Lxaero/map/mods/gui/WaypointSymbolCreator;getSymbolTexture(Lxaero/map/element/MapElementGraphics;Ljava/lang/String;)Lxaero/map/icon/XaeroIcon;"
    ))
    public XaeroIcon wrapSymbolIconGen(
        final WaypointSymbolCreator instance,
        final MapElementGraphics guiGraphics,
        final String c,
        ...
        return original.call(instance, guiGraphics, c);
    }
