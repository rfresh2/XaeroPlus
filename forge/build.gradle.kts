...
dependencies {
    ...
    modImplementation("maven.modrinth:xaeros-world-map:${worldmap_version}_Forge_1.19.1")
    modImplementation("maven.modrinth:xaeros-minimap:${minimap_version}_Forge_1.19.1")
