...
dependencies {
    ...
    modImplementation("maven.modrinth:xaeros-world-map:${worldmap_version}_Forge_1.20.2")
    modImplementation("maven.modrinth:xaeros-minimap:${minimap_version}_Forge_1.20.2")
