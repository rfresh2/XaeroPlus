        ...
        builder.registerModOptions("xaeroplus")
            .addPage(builder.createOptionPage()
                ...
                .addOptionGroup(builder.createOptionGroup()
                    .setName(Component.literal("XaeroPlus"))
                    .addOption(builder.createBooleanOption(ResourceLocation.fromNamespaceAndPath("xaeroplus", "minimap_fps_limiter"))
                    ...
                    .addOption(builder.createIntegerOption(ResourceLocation.fromNamespaceAndPath("xaeroplus", "minimap_fps_limit"))
