...
gradle.extra.apply {
	...
	set("minecraft_version", "1.20.5")
	set("parchment_version", "2024.02.25")
	set("fabric_loader_version", "0.15.10")
	set("fabric_api_version", "0.97.5+1.20.5")
	set("forge_loader_version", "49.0.3")
    set("neoforge_version", "20.5.4-beta")
    set("worldmap_version_fabric", "1.38.5")
	set("minimap_version_fabric", "24.1.2")
    set("worldmap_version_forge", "1.38.4")
    set("minimap_version_forge", "24.1.1")
    set("worldmap_version_neo", "1.38.5")
    set("minimap_version_neo", "24.1.2")
}
...
//			library("forge", "net.minecraftforge:forge:${gradle.extra.get("minecraft_version")}-${gradle.extra.get("forge_loader_version")}")
			...
			library("parchment", "org.parchmentmc.data:parchment-1.20.4:${gradle.extra.get("parchment_version")}")
