...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.153.0+$minecraft_version")
			library("neoforge", "net.neoforged:neoforge:$minecraft_version.0.7-beta")
...
//			library("xaerolib-forge", "xaero.lib:xaerolib-forge-1.21.11:${xaerolib_version}")
			...
			library("waystones-fabric", "net.blay09.mods:waystones-fabric:$minecraft_version.0.2")
			library("waystones-forge", "maven.modrinth:waystones:21.11.9+forge-1.21.11")
			library("waystones-neoforge", "net.blay09.mods:waystones-neoforge:$minecraft_version.0.2")
			library("balm-fabric", "net.blay09.mods:balm-fabric:$minecraft_version.0.1")
			library("balm-forge", "maven.modrinth:balm:21.11.8+forge-1.21.11")
			library("balm-neoforge", "net.blay09.mods:balm-neoforge:$minecraft_version.0.1")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.16.1+$minecraft_version-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.16.1+$minecraft_version-neoforge")
			library("modmenu", "maven.modrinth:modmenu:20.0.0-beta.4")
			library("sodium-fabric", "net.caffeinemc:sodium-fabric:0.9.0+mc$minecraft_version")
            library("sodium-neoforge", "net.caffeinemc:sodium-neoforge-mod:0.9.0+mc$minecraft_version")
            library("spark-fabric", "maven.modrinth:spark:1.10.173-fabric")
