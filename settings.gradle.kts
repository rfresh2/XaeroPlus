...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.152.2+$minecraft_version")
			library("neoforge", "net.neoforged:neoforge:$minecraft_version.0.6-beta")
...
//			library("xaerolib-forge", "xaero.lib:xaerolib-forge-1.21.11:${xaerolib_version}")
			...
			library("waystones-fabric", "net.blay09.mods:waystones-fabric:$minecraft_version.0.1")
			library("waystones-forge", "maven.modrinth:waystones:21.11.9+forge-1.21.11")
			library("waystones-neoforge", "net.blay09.mods:waystones-neoforge:$minecraft_version.0.1")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.16.0+$minecraft_version-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.16.0+$minecraft_version-neoforge")
			library("modmenu", "maven.modrinth:modmenu:20.0.0-beta.3")
