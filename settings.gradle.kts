...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:${gradle.extra.get("minecraft_version")}-49.1.4")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.97.1+${gradle.extra.get("minecraft_version")}")
