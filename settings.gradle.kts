...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("mixinextras-common", "io.github.llamalad7:mixinextras-common:0.5.5")
			library("mixinextras-forge", "io.github.llamalad7:mixinextras-forge:0.5.5")
			...
			library("opac-fabric", "maven.modrinth:open-parties-and-claims:fabric-$minecraft_version-0.31.6")
