...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.5.4+fabric-1.21.5")
			library("waystones-forge", "maven.modrinth:waystones:21.5.4+forge-1.21.5")
			library("waystones-neoforge", "maven.modrinth:waystones:21.5.4+neoforge-1.21.5")
			library("balm-fabric", "maven.modrinth:balm:21.5.13+fabric-1.21.5")
			library("balm-forge", "maven.modrinth:balm:21.5.13+forge-1.21.5")
			library("balm-neoforge", "maven.modrinth:balm:21.5.13+neoforge-1.21.5")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.9.3+1.21.5-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.9.3+1.21.5-neoforge")
			library("modmenu", "maven.modrinth:modmenu:14.0.0-rc.2")
			library("sodium-fabric", "maven.modrinth:sodium:mc1.21.5-0.6.13-fabric")
			library("sodium-neoforge", "maven.modrinth:sodium:mc1.21.5-0.6.13-neoforge")
//			library("fpsdisplay", "maven.modrinth:fpsdisplay:3.1.0+1.20.x")
            ...
            library("baritone-fabric", "com.github.rfresh2:baritone-fabric:1.21.4")
            library("baritone-forge", "com.github.rfresh2:baritone-forge:1.21.4")
            library("baritone-neoforge", "com.github.rfresh2:baritone-neoforge:1.21.4")
        }
	}
}
