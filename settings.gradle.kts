...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.155.2+$minecraft_version")
			library("neoforge", "net.neoforged:neoforge:$minecraft_version.87")
			...
			library("modmenu", "maven.modrinth:modmenu:18.0.0")
			library("sodium-fabric", "net.caffeinemc:sodium-fabric:0.9.1+mc$minecraft_version")
            library("sodium-neoforge", "net.caffeinemc:sodium-neoforge-mod:0.9.1+mc$minecraft_version")
