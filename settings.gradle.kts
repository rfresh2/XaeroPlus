...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:${minecraft_version}-48.1.0")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.91.6+${minecraft_version}")
            ...
            library("fpsdisplay", "maven.modrinth:fpsdisplay:3.1.0+1.20.2")
