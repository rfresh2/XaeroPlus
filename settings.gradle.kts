...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("fabric-waystones", "maven.modrinth:fwaystones:3.3.5+mc$minecraft_version")
			...
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.8.1+$minecraft_version-neoforge")
