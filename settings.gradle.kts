...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.125.3+1.21.5")
			library("neoforge", "net.neoforged:neoforge:21.5.75")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.9.5+1.21.5-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.9.5+1.21.5-neoforge")
