...
gradle.extra.apply {
	...
	set("minimap_version_fabric", "24.1.3")
    set("worldmap_version_forge", "1.38.6")
    set("minimap_version_forge", "24.1.3")
    set("worldmap_version_neo", "1.38.6")
    set("minimap_version_neo", "24.1.3")
}
...
//			library("forge", "net.minecraftforge:forge:${gradle.extra.get("minecraft_version")}-${gradle.extra.get("forge_loader_version")}")
			...
			library("worldmap-fabric", "maven.modrinth:xaeros-world-map:${gradle.extra.get("worldmap_version_fabric")}_Fabric_1.20.5")
//			library("worldmap-forge", "maven.modrinth:xaeros-world-map:${gradle.extra.get("worldmap_version_forge")}_Forge_1.20.5")
			library("worldmap-neo", "maven.modrinth:xaeros-world-map:${gradle.extra.get("worldmap_version_neo")}_NeoForge_1.20.5")
			library("minimap-fabric", "maven.modrinth:xaeros-minimap:${gradle.extra.get("minimap_version_fabric")}_Fabric_1.20.5")
//			library("minimap-forge", "maven.modrinth:xaeros-minimap:${gradle.extra.get("minimap_version_forge")}_Forge_1.20.5")
			library("minimap-neo", "maven.modrinth:xaeros-minimap:${gradle.extra.get("minimap_version_neo")}_NeoForge_1.20.5")
...
//			library("balm-forge", "maven.modrinth:balm:9.0.4+forge-1.20.4")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.2.12+1.20.5-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.2.12+1.20.5-neoforge")
			...
			library("mixinsquared-fabric", "com.github.bawnorton.mixinsquared:mixinsquared-fabric:0.1.2-beta.5")
			library("mixinsquared-common", "com.github.bawnorton.mixinsquared:mixinsquared-common:0.1.2-beta.5")
			library("mixinsquared-forge", "com.github.bawnorton.mixinsquared:mixinsquared-forge:0.1.2-beta.5")
		}
	}
}
