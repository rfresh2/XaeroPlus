...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:1.21.8-58.0.0")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.129.0+${minecraft_version}")
			library("neoforge", "net.neoforged:neoforge:21.8.2-beta")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.8.1+fabric-1.21.8")
			library("waystones-forge", "maven.modrinth:waystones:21.8.1+forge-1.21.8")
			library("waystones-neoforge", "maven.modrinth:waystones:21.8.1+neoforge-1.21.8")
			library("balm-fabric", "maven.modrinth:balm:21.8.3+fabric-1.21.8")
			library("balm-forge", "maven.modrinth:balm:21.8.3+forge-1.21.8")
			library("balm-neoforge", "maven.modrinth:balm:21.8.3+neoforge-1.21.8")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.12.0+1.21.8-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.12.0+1.21.8-neoforge")
...
//			library("fpsdisplay", "maven.modrinth:fpsdisplay:3.1.0+1.20.x")
            ...
            library("baritone-fabric", "com.github.rfresh2:baritone-fabric:1.21.7-SNAPSHOT")
            library("baritone-forge", "com.github.rfresh2:baritone-forge:1.21.7-SNAPSHOT")
            library("baritone-neoforge", "com.github.rfresh2:baritone-neoforge:1.21.7-SNAPSHOT")
        }
	}
}
