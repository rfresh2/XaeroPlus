...
//			library("forge", "net.minecraftforge:forge:1.21.8-58.0.10")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.133.0+1.21.9")
//			library("neoforge", "net.neoforged:neoforge:21.8.36")
			library("worldmap-fabric", "maven.modrinth:xaeros-world-map:${worldmap_version_fabric}_Fabric_1.21.8")
...
//			library("worldmap-neo", "maven.modrinth:xaeros-world-map:${worldmap_version_neo}_NeoForge_${minecraft_version}")
			library("minimap-fabric", "maven.modrinth:xaeros-minimap:${minimap_version_fabric}_Fabric_1.21.8")
...
//			library("minimap-neo", "maven.modrinth:xaeros-minimap:${minimap_version_neo}_NeoForge_${minecraft_version}")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.8.3+fabric-1.21.8")
//			library("waystones-forge", "maven.modrinth:waystones:21.8.3+forge-1.21.8")
//			library("waystones-neoforge", "maven.modrinth:waystones:21.8.3+neoforge-1.21.8")
			library("balm-fabric", "maven.modrinth:balm:21.8.5+fabric-1.21.8")
//			library("balm-forge", "maven.modrinth:balm:21.8.5+forge-1.21.8")
//			library("balm-neoforge", "maven.modrinth:balm:21.8.5+neoforge-1.21.8")
