...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("balm-fabric", "maven.modrinth:balm:21.11.9+fabric-${minecraft_version}")
			library("balm-forge", "maven.modrinth:balm:21.11.9+forge-${minecraft_version}")
			library("balm-neoforge", "maven.modrinth:balm:21.11.9+neoforge-${minecraft_version}")
