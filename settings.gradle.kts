...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("waystones-fabric", "maven.modrinth:waystones:14.1.3+fabric-1.20")
			library("waystones-forge", "maven.modrinth:waystones:14.1.3+forge-1.20")
			library("balm-fabric", "maven.modrinth:balm:7.3.4+fabric-1.20.1")
			library("balm-forge", "maven.modrinth:balm:7.3.4+forge-1.20.1")
