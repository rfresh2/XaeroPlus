...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:1.21.5-55.0.16")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.121.0+1.21.5")
			library("neoforge", "net.neoforged:neoforge:21.5.66-beta")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.5.5+fabric-1.21.5")
			library("waystones-forge", "maven.modrinth:waystones:21.5.5+forge-1.21.5")
			library("waystones-neoforge", "maven.modrinth:waystones:21.5.5+neoforge-1.21.5")
			library("balm-fabric", "maven.modrinth:balm:21.5.16+fabric-1.21.5")
			library("balm-forge", "maven.modrinth:balm:21.5.16+forge-1.21.5")
			library("balm-neoforge", "maven.modrinth:balm:21.5.16+neoforge-1.21.5")
