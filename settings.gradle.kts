...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("waystones-fabric", "maven.modrinth:waystones:14.1.13+fabric-1.20.1")
			library("waystones-forge", "maven.modrinth:waystones:14.1.13+forge-1.20.1")
			library("balm-fabric", "maven.modrinth:balm:7.3.30+fabric-1.20.1")
			library("balm-forge", "maven.modrinth:balm:7.3.30+forge-1.20.1")
