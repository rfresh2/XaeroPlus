...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("worldmap-neo", "maven.modrinth:xaeros-world-map:${gradle.extra.get("worldmap_version")}_NeoForge_${gradle.extra.get("minecraft_version")}")
			...
			library("minimap-forge", "maven.modrinth:xaeros-minimap:${"24.0.1"}_Forge_${gradle.extra.get("minecraft_version")}")
			library("minimap-neo", "maven.modrinth:xaeros-minimap:${"24.0.1"}_NeoForge_${gradle.extra.get("minecraft_version")}")
