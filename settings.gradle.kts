...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.92.6+${minecraft_version}")
			...
			library("waystones-fabric", "maven.modrinth:waystones:14.1.16+fabric-1.20.1")
			library("waystones-forge", "maven.modrinth:waystones:14.1.16+forge-1.20.1")
			library("balm-fabric", "maven.modrinth:balm:7.3.33+fabric-1.20.1")
			library("balm-forge", "maven.modrinth:balm:7.3.33+forge-1.20.1")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.5.1+1.20.4-fabric")
