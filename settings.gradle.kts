...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:${minecraft_version}-53.0.35")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.3.6+1.21.3-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.3.6+1.21.3-neoforge")
			library("modmenu", "maven.modrinth:modmenu:12.0.0")
			library("sodium-fabric", "maven.modrinth:sodium:mc1.21.3-0.6.9-fabric")
			library("sodium-neoforge", "maven.modrinth:sodium:mc1.21.3-0.6.9-neoforge")
