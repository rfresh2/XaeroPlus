...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.6.1+fabric-1.21.6")
			library("waystones-forge", "maven.modrinth:waystones:21.6.1+forge-1.21.6")
			library("waystones-neoforge", "maven.modrinth:waystones:21.6.1+neoforge-1.21.6")
			library("balm-fabric", "maven.modrinth:balm:21.6.1+fabric-1.21.6")
			library("balm-forge", "maven.modrinth:balm:21.6.1+forge-1.21.6")
			library("balm-neoforge", "maven.modrinth:balm:21.6.1+neoforge-1.21.6")
