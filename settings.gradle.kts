...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:1.21.10-60.0.3")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.135.0+${minecraft_version}")
			library("neoforge", "net.neoforged:neoforge:21.10.9-beta")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.10.1+fabric-${minecraft_version}")
			library("waystones-forge", "maven.modrinth:waystones:21.10.1+forge-${minecraft_version}")
			library("waystones-neoforge", "maven.modrinth:waystones:21.10.1+neoforge-${minecraft_version}")
			library("balm-fabric", "maven.modrinth:balm:21.10.1+fabric-${minecraft_version}")
			library("balm-forge", "maven.modrinth:balm:21.10.4+forge-${minecraft_version}")
			library("balm-neoforge", "maven.modrinth:balm:21.10.3+neoforge-${minecraft_version}")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.13.1+${minecraft_version}-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.13.1+${minecraft_version}-neoforge")
