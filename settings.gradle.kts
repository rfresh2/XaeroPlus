...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("neoforge", "net.neoforged:neoforge:21.8.10")
			...
			library("balm-fabric", "maven.modrinth:balm:21.8.4+fabric-1.21.8")
			library("balm-forge", "maven.modrinth:balm:21.8.4+forge-1.21.8")
			library("balm-neoforge", "maven.modrinth:balm:21.8.4+neoforge-1.21.8")
