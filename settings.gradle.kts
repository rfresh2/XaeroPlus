...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:1.21.5-55.0.24")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.128.1+1.21.5")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.5.8+fabric-1.21.5")
			library("waystones-forge", "maven.modrinth:waystones:21.5.8+forge-1.21.5")
			library("waystones-neoforge", "maven.modrinth:waystones:21.5.8+neoforge-1.21.5")
			library("balm-fabric", "maven.modrinth:balm:21.5.20+fabric-1.21.5")
			library("balm-forge", "maven.modrinth:balm:21.5.20+forge-1.21.5")
			library("balm-neoforge", "maven.modrinth:balm:21.5.20+neoforge-1.21.5")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.9.6+1.21.5-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.9.6+1.21.5-neoforge")
