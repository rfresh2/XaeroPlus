...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.11.9+fabric-1.21.11")
			library("waystones-forge", "maven.modrinth:waystones:21.11.9+forge-1.21.11")
			library("waystones-neoforge", "maven.modrinth:waystones:21.11.9+neoforge-1.21.11")
			library("balm-fabric", "maven.modrinth:balm:21.11.8+fabric-1.21.11")
			library("balm-forge", "maven.modrinth:balm:21.11.8+forge-1.21.11")
			library("balm-neoforge", "maven.modrinth:balm:21.11.8+neoforge-1.21.11")
