...
gradle.extra.apply {
	...
	set("forge_loader_version", "51.0.3")
    set("neoforge_version", "21.0.52-beta")
...
//			library("minimap-forge", "maven.modrinth:xaeros-minimap:${gradle.extra.get("minimap_version_forge")}_Forge_${gradle.extra.get("minecraft_version")}")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.0.1+fabric-1.21")
//			library("waystones-forge", "maven.modrinth:waystones:16.0.3+forge-1.20.4")
			library("waystones-neoforge", "maven.modrinth:waystones:21.0.1+neoforge-1.21")
			library("balm-fabric", "maven.modrinth:balm:21.0.6+fabric-1.21")
//			library("balm-forge", "maven.modrinth:balm:9.0.4+forge-1.20.4")
			library("balm-neoforge", "maven.modrinth:balm:21.0.6+neoforge-1.21")
			...
			library("modmenu", "maven.modrinth:modmenu:11.0.0-beta.1")
			library("sodium", "maven.modrinth:sodium:mc1.21-0.5.9")
//			library("fpsdisplay", "maven.modrinth:fpsdisplay:3.1.0+1.20.x")
            ...
            library("embeddium", "maven.modrinth:embeddium:1.0.0-beta.1+mc1.21")
        }
	}
}
