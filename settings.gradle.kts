...
dependencyResolutionManagement {
	versionCatalogs {
		create("libs") {
			...
			library("forge", "net.minecraftforge:forge:${minecraft_version}-54.1.2")
			library("fabric-api", "net.fabricmc.fabric-api:fabric-api:0.118.0+${minecraft_version}")
			library("neoforge", "net.neoforged:neoforge:21.4.109-beta")
			...
			library("waystones-fabric", "maven.modrinth:waystones:21.4.8+fabric-1.21.4")
			library("waystones-forge", "maven.modrinth:waystones:21.4.8+forge-1.21.4")
			library("waystones-neoforge", "maven.modrinth:waystones:21.4.8+neoforge-1.21.4")
			library("balm-fabric", "maven.modrinth:balm:21.4.17+fabric-1.21.4")
			library("balm-forge", "maven.modrinth:balm:21.4.17+forge-1.21.4")
			library("balm-neoforge", "maven.modrinth:balm:21.4.17+neoforge-1.21.4")
			...
			library("immediatelyfast", "maven.modrinth:immediatelyfast:1.3.6+1.21.4-fabric")
			library("immediatelyfast-neo", "maven.modrinth:immediatelyfast:1.3.6+1.21.4-neoforge")
			library("modmenu", "maven.modrinth:modmenu:13.0.2")
			library("sodium-fabric", "maven.modrinth:sodium:mc1.21.4-0.6.9-fabric")
			library("sodium-neoforge", "maven.modrinth:sodium:mc1.21.4-0.6.9-neoforge")
